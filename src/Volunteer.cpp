...
void CollectorVolunteer::step()
{
    ...
    if (isFinished)
    {
        ...
        activeOrderId = NO_ORDER;         // changes isBusy status to false, volunteer will be able to accept more orders now
    }
}
...
{
    activeOrderId = order.getId(); // changes the status of isBusy to true
    timeLeft = coolDown;
